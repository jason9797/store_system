...
def alert(alert_user,request_user,alert_content,alert_time,phone,customer):
    ...
    customer_alert=Customer_Alert.objects.filter(alert_user=User.objects.get(username=alert_user),add_user=request_user,content=alert_content,alert_time=alert_time)
