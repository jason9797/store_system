...
urlpatterns=patterns('',
            ...
            url(r'^server/record/$',order_server_record,name="order_server_record"),
            url(r'^alert/add/$',customer_alert_add,name="customer_alert_add"),
            url(r'^alert/info/$',customer_alert_info,name="customer_alert_info"),
            url(r'^alert/remove/$',customer_alert_remove,name="customer_alert_remove"),
