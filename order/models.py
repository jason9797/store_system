...
class Customer(models.Model):
    ...
    data = HStoreField(blank=True,verbose_name="额外数据")
    jointime =models.DateTimeField(verbose_name='添加时间',auto_now_add=True)
    #history = HistoricalRecords()
    class Meta:
        verbose_name='客户'
...
class Order(models.Model):
    ...
    issuing_person = models.ForeignKey('role.Issuing_person',blank=True,null=True,on_delete=models.SET_NULL,verbose_name='出单人')
