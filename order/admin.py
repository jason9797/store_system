...
class Stock_ProductAdmin(admin.ModelAdmin):
...
class OrderAdmin(admin.ModelAdmin):
    list_filter = ('delivery_no', 'fact_money', 'customer', 'issuing_person',
                   'product', 'state')
    list_display = ('delivery_no', 'fact_money', 'customer', 'issuing_person',
                    'product', 'state')
    search_fields = ['delivery_no']
    ordering = ('delivery_no', 'fact_money', 'customer', 'issuing_person',
                'product', 'state')
...
class Order_StateAdmin(admin.ModelAdmin):
    list_filter = ('name',)
    list_display = ('name',)
    search_fields = ['name']
    ordering = ('name',)
...
class Customer_LevelAdmin(admin.ModelAdmin):
    list_filter = ('level',)
    list_display = ('level',)
    search_fields = ['level']
    ordering = ('level',)
