...
def main():
    ...
    for i in order_info:
        ...
        order_save=Order_all_info(order_no=order_no,delivery_no=delivery_no,fact_money=fact_money,customer_id=customer_id,
                                  customer_name=customer_name,customer_sex=customer_sex,customer_level=customer_level,
                                  customer_level_name=customer_level_name,user_username=user_username,user_first_name=user_first_name,
                                  user_group_name=user_group_name,address=address,phone_number=phone_number,issuing_person=issuing_person,
                                  product_name=product_name,product_price=product_price,product_delivery_type=product_delivery_type,
                                  state_name=state_name,state_level=state_level,remark=remark,jointime=jointime)
        order_save.save()
