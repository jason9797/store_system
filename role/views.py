...
def user_add(request):
    if request.method=='POST':
        ...
        if user_form.is_valid():
            ...
            user.groups=groups
            response.write("<script language='javascript'>alert('添加成功!');window.location.href=document.referrer;</script>")
            return response
        else:
            response.write("<script language='javascript'>alert('添加失败!');window.location.href=document.referrer;</script>")
            return response
    # else:
...
def user_remove(request):
    ...
    if user.is_superuser:
        response.write("<script language='javascript'>alert('管理员无法删除!');window.location.href=document.referrer;</script>")
    else:
        user.delete()
        response.write("<script language='javascript'>alert('删除成功!');window.location.href=document.referrer;</script>")
    return response
...
def user_group_edit(request,username):
    if request.method=='POST':
        ...
        if group_form.is_valid():
            ...
            user.groups=groups
            user.save()
            response.write("<script language='javascript'>alert('修改成功!');window.location.href=document.referrer;</script>")
            return response
        else:
...
def server_goals_info(request):
    ...
    return render(request,"goal_info.html",{"goals":server_goals,"goal_form":goal_form,"user_list":user_list})
    ...
    if request.method=="POST":
        ...
        if form.is_valid():
            ...
            try:
                ...
                response.write("<script language='javascript'>alert('无法添加,已存在销售目标!');window.location.href=document.referrer;</script>")
                return response
            except:
                goal=User_goal(user=user,goal_quantity=goal_quantity,goal_money=goal_money,goal_chosen=goal_chosen)
                goal.save()
            response.write("<script language='javascript'>alert('添加成功!');window.location.href=document.referrer;</script>")
            return response
        else:
...
def server_cut_info(request):
    ...
    user_list=User.objects.filter(is_superuser=False)
    return render(request,"server_cut_info.html",{"cuts":server_cut,"cut_form":cut_form,"user_list":user_list})
    ...
    if request.method=="POST":
        ...
        if form.is_valid():
            ...
            try:
                ...
                response.write("<script language='javascript'>alert('无法添加,已有系数!');window.location.href=document.referrer;</script>")
                return response
            except:
                server_cut=Server_cut(server=server,cut_percentage=cut_percentage)
                server_cut.save()
            response.write("<script language='javascript'>alert('添加成功!');window.location.href=document.referrer;</script>")
            return response
        else:
...
def issuing_person_cut_info(request):
    ...
    return render(request,"issuing_person_cut_info.html",{"cuts":issuing_person_cut,"cut_form":cut_form,"user_list":issuing_person_list})
    ...
    if request.method=="POST":
        ...
        if form.is_valid():
            ...
            try:
                ...
                issuing_person_cut=Issuing_person_cut(issuing_person=issuing_person,cut_percentage=cut_percentage)
...
def issuing_person_cut_info_edit(request):
    if request.method=="POST":
        ...
        if name=='issuing_person':
            ...
            value=request.POST.get('value')
        info_dict={'%s'%name:value}
        issuing_person_cut=Issuing_person_cut.objects.filter(pk=request.POST.get("pk"))
