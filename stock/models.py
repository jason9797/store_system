...
class Stock(models.Model):
    ...
    stock_type = models.ForeignKey('Stock_Type',
                                   verbose_name='类别',
                                   blank=True,
                                   null=True,
                                   on_delete=models.SET_NULL)
    stock_channel = models.ForeignKey('Stock_Channel',
                                      verbose_name='进货渠道',
                                      blank=True,
                                      null=True,
                                      on_delete=models.SET_NULL)
...
class Stock_Management(models.Model):
    ...
    product = models.ForeignKey('order.Product',
                                verbose_name='产品',
                                blank=True,
                                null=True,
                                on_delete=models.SET_NULL)
    mode = models.ForeignKey('Stock_Mode',
                             verbose_name='出入方式',
                             blank=True,
                             null=True,
                             on_delete=models.SET_NULL)
